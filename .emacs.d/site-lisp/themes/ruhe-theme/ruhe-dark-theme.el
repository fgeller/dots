...
(custom-theme-set-faces
 ...
 `(highlight ((t (:background "#8e5ff4" :distant-foreground "#000000"))))
 ...
 `(minibuffer-prompt ((t (:foreground "#78909c" :background nil))))
 ...
 `(header-line ((t (:background "#757575" :foreground "#f5f5f5" :inherit nil))))
 ...
 `(button ((t (:foreground "#03A9F4" :underline nil))))
 `(widget-button ((t (:foreground "#03A9F4" :underline nil))))
 `(widget-field ((t (:background "#b4b7b4" :box (:line-width 1 :color "#282a2e")))))
 `(browse-url-button ((t (:foreground "#03A9F4" :underline nil))))
 `(info-menu-header ((t (:weight normal :underline nil))))
 `(info-xref ((t (:foreground "#03A9F4" :underline nil))))
 `(info-xref-visited ((t (:foreground "#9C27B0" :underline nil))))
 `(link ((t (:foreground "#03A9F4" :underline nil))))
 ...
 `(lsp-headerline-breadcrumb-path-error-face ((t (:inherit error :underline nil))))
 `(lsp-headerline-breadcrumb-path-warning-face ((t (:inherit warning :underline nil))))
 ...
 `(font-lock-comment-face ((t (:foreground nil :background "#424242" :underline nil))))
 `(font-lock-doc-face ((t (:foreground nil :background "#424242" :underline nil))))
 ...
 `(magit-diff-added ((t (:background "#81C784" :foreground "#000000"))))
 `(magit-diff-added-highlight ((t (:background "#81C784" :foreground "#000000"))))
 ...
 `(magit-diff-hunk-heading-highlight ((t (:background "#FFF176" :foreground "#000000"))))
 ...
 `(magit-diff-removed ((t (:background "#E57373" :foreground "#000000"))))
 `(magit-diff-removed-highlight ((t (:background "#E57373" :foreground "#000000"))))
