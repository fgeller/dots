...
(custom-theme-set-faces
 ...
 ;; `(highlight ((t (:background nil :underline (:color "#4CAF50" :style line) :weight normal :distant-foreground "#000000"))))
 ;; `(highlight ((t (:foreground "#155dfc" :distant-foreground "#000000"))))
 `(highlight ((t (:foreground "#e12afb" :distant-foreground "#000000"))))
 ...
 `(button ((t (:foreground "#3F51B5" :underline t))))
