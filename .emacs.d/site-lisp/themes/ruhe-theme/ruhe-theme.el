...
(custom-theme-set-faces
 ...
 `(diff-file-header ((t (:background nil :weight normal :foreground "#bdbdbd"))))
 `(diff-header ((t (:background nil :foreground "#bdbdbd"))))
 `(diff-hunk-header ((t (:background nil :foreground "#bdbdbd"))))
