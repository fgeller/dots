...
(defconst c-bindings-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map (kbd "lS") 'consult-lsp-file-symbols)
...
(define-key fg/window-map (kbd "r") '3w-shift-right)
...
(define-key modal-mode-map (kbd "gI") 'lsp-find-implementation)
