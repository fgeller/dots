...
(let ((map fg/go-keymap))
  (define-key map (kbd "l") 'fg/go-compilation-toggle-truncate-lines)
  (define-key map (kbd "t") 'fg/go-run-all-tests)
  (define-key map (kbd "T") 'fg/go-run-this-test)
  (define-key map (kbd "e") 'fg/go-goto-first-error)
  (define-key map (kbd "n") 'fg/go-goto-next-error)
  (define-key map (kbd "p") 'fg/go-goto-previous-error)
  (define-key map (kbd "i") 'fg/go-ignore-all-tests)
  (define-key map (kbd "I") 'fg/go-enable-all-tests)
  (define-key map (kbd "r") 'fg/go-run-this)
  (define-key map (kbd "mb") 'fg/go-make-build)
  (define-key map (kbd "mt") 'fg/go-make-tests)
  (define-key map (kbd "g") 'fg/go-play))
